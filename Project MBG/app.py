...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab1:
        ...
        if col_seed2.button("📥 Isi dari Dataset Mei 2026", use_container_width=True):
            res_seed, err_seed = api_post("/inventory/seed-dari-dataset", {})
            if err_seed:
                st.error(err_seed, icon="❌")
            else:
                st.success(res_seed.get("pesan", "Berhasil."), icon="✅")
                st.rerun()
